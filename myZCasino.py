...
while rejouer == "o": 
    nombre_mise = 1
    while nombre_mise not in range(50):
        nombre_mise = int(input("Tapez le nombre sur lequel vous voulez miser (entre 0 et 49) : "))
    ...
    if nombre_mise == roulette:
        ...
        print("Vous avez gagner. Recevez trois fois la mise.")
